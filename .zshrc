...
# Show git diff
function gd() {
    git diff $@ -- $(_git_diff_exclude_args)
}

# Show git diff --staged
function gds() {
    git diff --staged $@ -- $(_git_diff_exclude_args)
}

# Try to get exlude files for `git diff`.
# There are autogenerated files which should not be reviewed.
function _git_diff_exclude_args() {
